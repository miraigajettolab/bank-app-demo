...
class ClientManageTransactions  extends React.Component {
  constructor(props) {
		super(props);
		this.state = {
  ...
  processAddTransaction(){
    ...
    fetch(this.props.serverURL + `/add-transaction-client?SourceAccountId=${this.state.SourceAccountId}&TransferAccountId=${this.state.TransferAccountId}&Total=${this.state.Total}&Currency=${this.state.Currency}`, 
      {
      method: 'GET',
      headers: {
  ...
  render() {
    return (
      <div className="ClientManageTransactions" >
...
export default ClientManageTransactions;
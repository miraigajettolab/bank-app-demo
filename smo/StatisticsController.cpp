...
SourceStat::SourceStatPointer SourceStat::instance;

SourceStat::SourceStatPointer SourceStat::getInstance()
{   if (SourceStat::instance == nullptr) {
        SourceStat::instance
                = SourceStat::SourceStatPointer(new SourceStat());
    }
    return SourceStat::instance;
}
